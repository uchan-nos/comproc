...
test_value 05 'int main() {int *p = 0x82; while(*p == -1){} return *p + 1;}' fe04
...
test_value 04 'void isr(){int *p=0x2f0; *p=4;} int main(){int *p=0x2f0; *p=1; asm("push isr\n\t" "isr\n\t" "int"); return *p;}'
...
test_value 05 'void _ISR(){int*p=0x2f0;*p+=1;int*t=2;*t=0;} int main(){int*t=2;int*c=4;int*p=0x2f0; asm("push _ISR\n\tisr"); *p=3;*c=2;*t=1;while(*t){} *t=1;while(*t){} return *p;}'
