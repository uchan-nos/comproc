...
test_value 05 'int main() {int *p = 0x06; while((p[1]&1) == 0); return *p + 1;}' "7e 04"
...
test_value 05 'int main() {int *p=0x06; int s=0; int c=0; while(1){while((p[1]&1)==0); c=p[0]; if(c==0x7ffe)break; s+=c&255;} return s;}' "7e 02 7e 03 7f fe"
